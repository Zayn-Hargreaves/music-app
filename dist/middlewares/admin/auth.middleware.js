    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [3 /*break*/, 5];
            case 1: return [4 /*yield*/, accounts_model_1.default.findOne({ token: req.cookies.token }).select("-password")];
            case 2:
                user = _a.sent();
                if (!!user) return [3 /*break*/, 3];
                res.redirect("".concat(congfix_1.systemConfig.prefixAdmin, "/auth/login"));
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, roles_model_1.default.findOne({ _id: user.role_id }).select("title permissions")];
            case 4:
                role = _a.sent();
