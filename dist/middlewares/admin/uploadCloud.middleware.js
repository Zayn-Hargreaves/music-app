...
var uploadToCloudinary_1 = require("../../helper/uploadToCloudinary");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, uploadToCloudinary_1.uploadToCloudinary)(req["file"].buffer)];
            case 1:
                link = _a.sent();
...
var uploadFields = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 3:
                _f.trys.push([3, 5, , 6]);
                return [4 /*yield*/, (0, uploadToCloudinary_1.uploadToCloudinary)(item.buffer)];
            case 4:
                link = _f.sent();
                links.push(link);
                return [3 /*break*/, 6];
