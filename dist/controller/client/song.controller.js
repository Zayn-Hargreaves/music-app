...
var favoriterSong_model_1 = __importDefault(require("../../model/favoriterSong.model"));
...
var detail = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var slugSong, song, singer, topic, favoriterSong, tmp, regex, lrc;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 3:
                topic = _a.sent();
                return [4 /*yield*/, favoriterSong_model_1.default.findOne({
                        songId: song.id
                    })];
            case 4:
                favoriterSong = _a.sent();
                tmp = song.lyrics;
                regex = /\[\d{2}:\d{2}:\d{2}\]/g;
                lrc = tmp.replace(regex, "");
                song["lrc"] = lrc;
                song["favorite"] = favoriterSong ? true : false;
...
var favorite = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var idSong, typeFavorite, _a, existFavoriteSong, newRecord;
        ...
        switch (_b.label) {
            case 0:
                ...
                switch (_a) {
                    ...
                    case "unfavorite": return [3 /*break*/, 3];
                }
                return [3 /*break*/, 5];
            case 1: return [4 /*yield*/, favoriterSong_model_1.default.findOne({
                    songId: idSong
                })];
            case 2:
                existFavoriteSong = _b.sent();
                if (!existFavoriteSong) {
                    newRecord = new favoriterSong_model_1.default({
                        songId: idSong,
                    });
                    newRecord.save();
                }
                return [3 /*break*/, 6];
            case 3: return [4 /*yield*/, favoriterSong_model_1.default.findOneAndDelete({
                    songId: idSong
                })];
            case 4:
                _b.sent();
