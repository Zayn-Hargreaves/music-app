...
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var favoriteSong, _i, favoriteSong_1, song, infoSong, infoSinger;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, favoriterSong_model_1.default.find({
                    deleted: false
                })];
            case 1:
                favoriteSong = _a.sent();
                _i = 0, favoriteSong_1 = favoriteSong;
                _a.label = 2;
            case 2:
                if (!(_i < favoriteSong_1.length)) return [3 /*break*/, 6];
                song = favoriteSong_1[_i];
